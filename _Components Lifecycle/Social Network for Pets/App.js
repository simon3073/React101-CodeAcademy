...
class App extends React.Component {
	...
	render() {
		...
		if (this.state.currentUsername) {
			body = <Profile username={this.state.currentUsername} onChoose={this.handleChoose} />;
		} else {
		...
		return (
			<div className="App">
				<header>
					...
					<nav>{this.state.currentUsername && <button onClick={this.handleReturnToDirectoryClick}>Return to directory</button>}</nav>
				</header>
